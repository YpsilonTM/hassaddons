...
config = {
    ...
    'mqtt': {
        ...
        'topic_prefix': options.get('topic_prefix', 'prod/device'),
        ...
        'discovery_device_name': options.get('discovery_device_name', 'Generic Device'),
        'discovery_device_manufacturer': options.get('discovery_device_manufacturer', 'Generic'),
